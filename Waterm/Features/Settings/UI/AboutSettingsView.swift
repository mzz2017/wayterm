        ...
        Form {
            ...
            Section("Support") {
                Link(destination: URL(string: "https://apps.apple.com/app/id6757482822?action=write-review")!) {
                    Label("Rate Waterm", systemImage: "star")
                }
                .tint(.primary)
                .foregroundStyle(.primary)

                Link(destination: URL(string: "https://github.com/mzz2017/waterm/issues")!) {
            ...
            Section("Links") {
                Link(destination: URL(string: "https://waterm.com")!) {
                    Label("Visit Website", systemImage: "globe")
                }
                .tint(.primary)
                .foregroundStyle(.primary)

                Link(destination: URL(string: "https://github.com/mzz2017/waterm")!) {
            ...
            Section("Legal") {
                Link(destination: URL(string: "https://waterm.com/privacy")!) {
                    Label("Privacy Policy", systemImage: "hand.raised")
                }
                .tint(.primary)
                .foregroundStyle(.primary)

                Link(destination: URL(string: "https://waterm.com/terms")!) {
