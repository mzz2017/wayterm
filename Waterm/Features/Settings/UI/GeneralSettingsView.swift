    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Toggle("Help Improve Waterm", isOn: $settingsStore.isAnalyticsEnabled)

                Toggle(
                    String(format: String(localized: "Require %@ to open Waterm"), appLockManager.biometryDisplayName),
                    isOn: Binding(
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("Help Improve Waterm shares anonymous statistics about which features are used — never what you type, your servers, or anything that identifies you.")
