...
final class AppLockManager: ObservableObject {
    ...
    func requestSetFullAppLockEnabled(_ enabled: Bool) async {
        ...
        let reason = String(format: String(localized: "Enable %@ for Waterm"), biometryDisplayName)
    ...
    func ensureAppUnlocked() async -> Bool {
        ...
        let reason = String(format: String(localized: "Unlock Waterm with %@"), biometryDisplayName)
