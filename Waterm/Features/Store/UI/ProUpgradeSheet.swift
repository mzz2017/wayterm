...
struct ProUpgradeSheet: View {
    ...
    private var sheetContent: some View {
        ...
        .manageSubscriptionsSheetCompat(
            ...
            subscriptionGroupID: WatermProducts.subscriptionGroupId
        )
        #endif
    }
    ...
    private var footerSupportRow: some View {
        HStack(spacing: 6) {
            ...
            legalLink(title: "Terms", url: "https://waterm.com/terms")

            Text(verbatim: "•")
                .foregroundStyle(.tertiary)

            legalLink(title: "Privacy", url: "https://waterm.com/privacy")

            Text(verbatim: "•")
                .foregroundStyle(.tertiary)

            legalLink(title: "Refund", url: "https://waterm.com/refund")
        }
        .font(.caption)
        .foregroundStyle(.secondary)
        .lineLimit(1)
    ...
    private var subscribeButtonTitle: String {
        ...
        if product.id == WatermProducts.proLifetime {
    ...
    private func handlePurchaseStateChange(_ newState: PurchaseState) {
        ...
        case .purchased:
            ...
            if storeManager.lastPurchasedProductId == WatermProducts.proLifetime,
