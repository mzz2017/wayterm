...
enum WatermProducts {
    static let proMonthly = "com.vivy.waterm.pro.monthly"
    static let proYearly = "com.vivy.waterm.pro.yearly"
    static let proLifetime = "com.vivy.waterm.pro.lifetime"

    static let subscriptionGroupId = "waterm_pro"
