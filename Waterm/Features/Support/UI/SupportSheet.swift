...
struct SupportSheet: View {
    ...
    private let contactOptions: [ContactOption] = [
        ...
        ContactOption(title: String(localized: "Email"), subtitle: "waterm@vivy.company", icon: "envelope.fill", iconImage: nil, iconText: nil, color: .orange, url: "mailto:waterm@vivy.company"),
        ContactOption(title: String(localized: "GitHub"), subtitle: String(localized: "Report Issue"), icon: "exclamationmark.triangle.fill", iconImage: nil, iconText: nil, color: .red, url: "https://github.com/mzz2017/waterm/issues"),
        ContactOption(title: String(localized: "Rate Waterm"), subtitle: String(localized: "Leave a review on the App Store"), icon: "star.fill", iconImage: nil, iconText: nil, color: .yellow, url: "https://apps.apple.com/app/id6757482822?action=write-review")
    ]
