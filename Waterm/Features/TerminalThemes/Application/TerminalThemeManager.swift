...
final class UserDefaultsTerminalThemeCustomThemeStore: TerminalThemeCustomThemeStoring {
    ...
    private let logger = Logger(
        subsystem: Bundle.main.bundleIdentifier ?? "app.vivy.waterm",
...
final class TerminalThemeManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "app.vivy.waterm", category: "TerminalThemeManager")
