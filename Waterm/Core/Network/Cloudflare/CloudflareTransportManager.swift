...
actor CloudflareTransportManager: CloudflareTransportManaging {
    ...
    private let callbackScheme = "waterm-cfaccess"
    private let userAgent = "Waterm"
    private let discoveryTimeout: TimeInterval = 12
    private let disconnectTimeout: Duration
    private let metadataKeychain = KeychainStore(service: "app.vivy.waterm.cloudflare.metadata")
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Waterm", category: "CloudflareTransport")
