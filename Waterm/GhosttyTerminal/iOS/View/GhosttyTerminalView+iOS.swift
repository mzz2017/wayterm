...
class GhosttyTerminalView: UIView {
    static let textInputContextID = "app.vivy.Waterm.GhosttyTerminalView"
    ...
    static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "app.vivy.waterm", category: "GhosttyTerminal")
