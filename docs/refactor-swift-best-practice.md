...
- Task 40E: Remaining destructive action tracking. Audit delete/save flows not covered by 40A-40D and add focused tests for any dropped lifecycle result.
  ...
  - Task 40E3: Settings destructive/persistence actions. Classify Keychain, generated-key save/delete, and trusted-host reset flows.
    ...
    - Task 40E3b: Keychain stored-key import/delete ownership. Classify `KeychainSettingsView` save/delete flows and move dropped lifecycle work to Settings Application if needed.
    - Task 40E3c: Generated-key save/delete ownership. Classify generated SSH key persistence and deletion flows after 40E3b.
