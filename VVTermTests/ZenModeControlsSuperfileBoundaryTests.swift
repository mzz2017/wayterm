...
struct ZenModeControlsSuperfileBoundaryTests {
    ...
    func zenModeControlsOwnsSharedChromeWithoutDefiningPlatformPanels() throws {
        ...
        let sharedSource = try source(
            at: root.appendingPathComponent("VVTerm/Features/TerminalSessions/UI/Terminal/ZenModeControls.swift")
        )
        let macOSPanelSource = try source(
            at: root.appendingPathComponent("VVTerm/Features/TerminalSessions/UI/Terminal/MacOSZenModePanel.swift")
        )
        let iOSPanelSource = try source(
            at: root.appendingPathComponent("VVTerm/Features/TerminalSessions/UI/Terminal/IOSZenModePanel.swift")
        )
