...
struct SSHKeyGeneratorErrorDetailTests {
    ...
    func retainedCFErrorDetailConsumesErrorAndPreservesRawDescription() {
        ...
        let cfError = CFErrorCreate(
            kCFAllocatorDefault,
            "Waterm.SecurityTest" as CFString,
            -42,
            userInfo
        )!
        ...
        #expect(detail?.contains("Waterm.SecurityTest") == true)
    ...
    func generatorErrorKeepsUserFacingCopyGenericWhilePreservingRawDetail() {
        ...
        let error = SSHKeyGeneratorError.keyGenerationFailed(
            underlyingDescription: "Waterm.SecurityTest -42 Security denied test key generation"
        )
        ...
        #expect(error.underlyingSecurityErrorDescription?.contains("Waterm.SecurityTest") == true)
