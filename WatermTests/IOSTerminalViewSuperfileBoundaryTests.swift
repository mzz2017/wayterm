...
struct IOSTerminalViewSuperfileBoundaryTests {
    ...
    func iosTerminalViewDoesNotOwnFloatingControlOrConnectingChrome() throws {
        ...
        let rootSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/iOSTerminalView.swift")
        )
        let componentSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalFloatingControls.swift")
        )
    ...
    func iosTerminalViewComposesNavigationToolbarWithoutOwningToolbarChrome() throws {
        ...
        let toolbarSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalNavigationToolbar.swift")
        )
    ...
    func iosTerminalViewComposesZenOverlayWithoutOwningOverlayChrome() throws {
        ...
        let overlaySource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalZenModeOverlay.swift")
        )
    ...
    func iosTerminalViewComposesSessionPageWithoutOwningSessionPageChrome() throws {
        ...
        let sessionPageSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalSessionPage.swift")
        )
    ...
    func iosTerminalViewComposesTabSwipeOverlayWithoutOwningGestureChrome() throws {
        ...
        let overlaySource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalTabSwipeOverlay.swift")
        )
    ...
    func iosTerminalViewComposesPresentationHostWithoutOwningSheetsAndAlerts() throws {
        ...
        let presentationSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/UI/iOS/IOSTerminalPresentationHost.swift")
        )
    ...
    func iosTerminalViewUsesInjectedViewTabConfiguration() throws {
        ...
        let appSource = try source(
            at: root.appendingPathComponent("Waterm/App/iOS/iOSContentView.swift")
        )
    ...
    func iosTerminalViewUsesPolicyForDerivedDisplayState() throws {
        ...
        let policySource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/IOSTerminalViewPolicy.swift")
        )
