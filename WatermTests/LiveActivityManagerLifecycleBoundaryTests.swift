...
struct LiveActivityManagerLifecycleBoundaryTests {
    ...
    func refreshesAreTrackedAndGuardedByRequestIDAcrossActivityKitAwaits() throws {
        let source = try source(
            at: sourceRoot().appendingPathComponent("Waterm/Features/TerminalSessions/Application/LiveActivityManager.swift")
        )
        ...
        #expect(
            !source.contains("private var activity: Activity<WatermActivityAttributes>?"),
