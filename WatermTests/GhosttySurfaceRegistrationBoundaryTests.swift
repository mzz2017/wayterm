...
struct GhosttySurfaceRegistrationBoundaryTests {
    ...
    func platformTerminalViewsDelegateSurfaceRegistrationToLease() throws {
        ...
        let macOSLifecycleSource = try source(
            at: root.appendingPathComponent("Waterm/GhosttyTerminal/macOS/TerminalMacOSSurfaceLifecycleRuntime.swift")
        )
        ...
        let registrationSource = try source(
            at: root.appendingPathComponent("Waterm/GhosttyTerminal/Surface/GhosttySurfaceRegistration.swift")
        )
