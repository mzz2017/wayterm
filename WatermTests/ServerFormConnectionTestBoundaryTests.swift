...
struct ServerFormConnectionTestBoundaryTests {
    ...
    func operationTesterUsesInjectedTransportServices() throws {
        ...
        let testerSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Servers/Application/ServerConnectionTester.swift")
        )
        let liveSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Servers/Infrastructure/ServerConnectionTester+Live.swift")
        )
