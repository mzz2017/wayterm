...
struct SSHClientSupportOwnerTests {
    ...
    func moshShellStreamTerminationIsOwnedByClientTeardownRegistry() throws {
        let source = try source(at: sourceRoot().appendingPathComponent("Waterm/Core/SSH/SSHClient.swift"))
    ...
    func teardownRegistriesUseSharedCallbackTaskRegistryWithDetachedCleanup() throws {
        for path in [
            "Waterm/Core/SSH/SSHChannelCleanupTaskRegistry.swift",
            "Waterm/Core/SSH/SSHMoshTeardownTaskRegistry.swift"
        ] {
