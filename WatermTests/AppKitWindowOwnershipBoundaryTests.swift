...
struct AppKitWindowOwnershipBoundaryTests {
    ...
    func singletonWindowPresentersLiveInApplicationLayer() throws {
        ...
        let aboutUI = try source(at: root.appendingPathComponent("Waterm/Features/Settings/UI/AboutView.swift"))
        let proUpgradeUI = try source(at: root.appendingPathComponent("Waterm/Features/Store/UI/ProUpgradeSheet.swift"))
        let proUpgradePresentationUI = try source(
            at: root.appendingPathComponent("Waterm/Features/Store/UI/ProUpgradePresentation.swift")
        )
        ...
        #expect(
            FileManager.default.fileExists(
                atPath: root
                    .appendingPathComponent("Waterm/Features/Settings/Application/AboutWindowPresenter.swift")
                    .path
            ),
        ...
        #expect(
            FileManager.default.fileExists(
                atPath: root
                    .appendingPathComponent("Waterm/Features/Store/Application/ProUpgradeWindowPresenter.swift")
                    .path
            ),
        ...
        #expect(
            FileManager.default.fileExists(
                atPath: root
                    .appendingPathComponent("Waterm/Features/Store/Application/ProUpgradeWindowPresentationService.swift")
                    .path
            ),
