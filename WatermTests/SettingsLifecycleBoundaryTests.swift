...
struct SettingsLifecycleBoundaryTests {
    ...
    func terminalSettingsDelegatesTrustedHostCleanupToApplicationStore() throws {
        ...
        let source = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/TerminalSettingsView.swift")
        )
    ...
    func keychainSettingsDelegatesSSHKeyLibraryLifecycleToApplicationStore() throws {
        ...
        let root = try sourceRoot()
        let source = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/KeychainSettingsView.swift")
        )
    ...
    func terminalSettingsDoesNotSwallowCustomThemePersistenceFailures() throws {
        ...
        let customThemeManagementSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/TerminalCustomThemeManagementViews.swift")
        )
    ...
    func syncSettingsDelegatesCloudKitStatusAndIntentToApplicationStore() throws {
        ...
        let viewSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SyncSettingsView.swift")
        )
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/Application/SyncSettingsStore.swift")
        )
    ...
    func proAndSyncSettingsReceiveBusinessStoresFromSettingsRoot() throws {
        ...
        let proSettingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/ProSettingsView.swift")
        )
        let syncSettingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SyncSettingsView.swift")
        )
        let settingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SettingsView.swift")
        )
    ...
    func aboutSettingsReceivesStoreManagerFromSettingsRoot() throws {
        ...
        let aboutSettingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/AboutSettingsView.swift")
        )
        let settingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SettingsView.swift")
        )
    ...
    func sfSymbolPickerReceivesCatalogAndRecentStoreFromCaller() throws {
        ...
        let pickerSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SFSymbolPickerView.swift")
        )
        let formSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalPresets/UI/Settings/TerminalPresetFormView.swift")
        )
        let servicesSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/Application/SFSymbolSettingsServices.swift")
        )
    ...
    func transcriptionSettingsReceivesStoresFromSettingsRoot() throws {
        ...
        let transcriptionSettingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/VoiceInput/UI/Settings/TranscriptionSettingsView.swift")
        )
        let settingsSource = try source(
            at: root.appendingPathComponent("Waterm/Features/Settings/UI/SettingsView.swift")
        )
