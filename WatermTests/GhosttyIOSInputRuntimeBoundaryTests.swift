...
struct GhosttyIOSInputRuntimeBoundaryTests {
    ...
    func iOSTerminalViewDelegatesHardwareKeyAndPreeditRuntimeToInputOwner() throws {
        ...
        let runtimeSource = try source(
            at: root.appendingPathComponent("Waterm/GhosttyTerminal/iOS/Input/TerminalIOSInputRuntime.swift")
        )
        ...
        let surfaceInputSource = try source(
            at: root.appendingPathComponent("Waterm/GhosttyTerminal/iOS/Surface/TerminalIOSSurfaceInputRuntime.swift")
        )
