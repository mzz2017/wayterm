...
// Test Context:
// Protects the Ghostty config text generated by Waterm before it is loaded
...
// created. Update these expectations when Waterm intentionally changes its
...
struct GhosttyConfigBuilderTests {
    ...
    func iOSConfigContentAppliesSafeOutputProfile() {
        ...
        // When Waterm applies its conservative iOS output profile.
        let expectedLines = [
