...
struct GhosttyIOSSurfaceLifecycleRuntimeTests {
    ...
    func iOSTerminalViewDelegatesSurfaceLifecycleFFIAndTeardownToRuntimeOwner() throws {
        ...
        let runtimeSource = try source(
            at: root.appendingPathComponent("Waterm/GhosttyTerminal/iOS/Surface/TerminalIOSSurfaceLifecycleRuntime.swift")
        )
        ...
        #expect(ownerSource.contains("private let surfaceLifecycleRuntime: TerminalIOSSurfaceLifecycleRuntime"))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.cleanup("))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.pauseRendering("))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.resumeRendering("))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.setFocus("))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.setOcclusion("))
        #expect(ownerSource.contains("surfaceLifecycleRuntime.processExited(surface: surface)"))
