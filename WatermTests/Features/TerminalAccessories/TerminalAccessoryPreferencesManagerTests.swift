...
final class TerminalAccessoryPreferencesManagerTests: XCTestCase {
    ...
    func testCloudSyncObserversUseTrackedApplicationTasks() throws {
        ...
        let source = try source(
            at: root.appendingPathComponent(
                "Waterm/Features/TerminalAccessories/Application/TerminalAccessoryPreferencesManager.swift"
            )
        )
    ...
    func testLiveCloudSyncDependenciesStayOutsidePreferencesManager() throws {
        ...
        let liveDependencySource = try source(
            at: root.appendingPathComponent(
                "Waterm/App/TerminalAccessoryPreferencesLiveDependencies.swift"
            )
        )
        let cloudSyncSource = try source(
            at: root.appendingPathComponent(
                "Waterm/Features/TerminalAccessories/Infrastructure/TerminalAccessoryPreferencesCloudSync.swift"
            )
        )
        let pendingLiveSyncSource = try source(
            at: root.appendingPathComponent(
                "Waterm/App/CloudKitPendingMutationLiveSync.swift"
            )
        )
