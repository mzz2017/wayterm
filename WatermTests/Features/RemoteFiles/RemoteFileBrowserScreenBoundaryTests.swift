...
struct RemoteFileBrowserScreenBoundaryTests {
    ...
    func screenDoesNotOwnRemoteNameOrPathValidationPolicy() throws {
        ...
        let screenSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen.swift")
        )
        let transferSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/Application/RemoteFileTransferCoordinator.swift")
        )
        let transferPolicySource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/Application/RemoteFileTransferPolicy.swift")
        )
    ...
    func screenDoesNotOwnDownloadTemporaryURLCreation() throws {
        ...
        let storageSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/Infrastructure/RemoteFileTemporaryStorage.swift")
        )
    ...
    func platformSupportDoesNotOwnMacOSTableViewImplementation() throws {
        ...
        let supportSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Platform/RemoteFileBrowserSupport.swift")
        )
        let tableSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Platform/RemoteFileBrowserMacTableView.swift")
        )
        let cellSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Platform/RemoteFileBrowserMacTableCells.swift")
        )
        let filePromiseSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Platform/RemoteFileBrowserMacFilePromise.swift")
        )
    ...
    func screenDoesNotOwnActionMenuPresentation() throws {
        ...
        let menuSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+Menus.swift")
        )
    ...
    func screenDoesNotOwnDragDropPresentationGlue() throws {
        ...
        let dragDropSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+DragDrop.swift")
        )
    ...
    func screenDoesNotOwnTransferStatusPresentation() throws {
        ...
        let transferSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+TransferStatus.swift")
        )
    ...
    func screenDoesNotOwnFileTransferGlue() throws {
        ...
        let transferSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+FileTransfers.swift")
        )
    ...
    func screenDoesNotOwnBrowserLabelFormatting() throws {
        ...
        let labelSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+Labels.swift")
        )
    ...
    func screenDoesNotOwnMacOSPanelPresentation() throws {
        ...
        let panelSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+MacOSPanels.swift")
        )
    ...
    func screenDoesNotOwnToolbarCommandRouting() throws {
        ...
        let toolbarCommandSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+ToolbarCommands.swift")
        )
    ...
    func screenDoesNotOwnSheetPresentationHelpers() throws {
        ...
        let sheetSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+Sheets.swift")
        )
    ...
    func browserSheetCollectionDoesNotOwnPermissionEditorImplementation() throws {
        ...
        let sheetCollectionSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Sheets/RemoteFileBrowserSheets.swift")
        )
        let permissionEditorSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Sheets/RemoteFilePermissionEditorSheet.swift")
        )
    ...
    func screenAndInspectorDoNotOwnPermissionEditPolicy() throws {
        ...
        let inspectorSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/Preview/RemoteFileInspectorMetadataViews.swift")
        )
        let policySource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/Application/RemoteFilePermissionEditPolicy.swift")
        )
    ...
    func screenDoesNotOwnMacOSInlineEditRouting() throws {
        ...
        let inlineEditSource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/UI/RemoteFileBrowserScreen+MacOSInlineEdit.swift")
        )
        let policySource = try source(
            at: root.appendingPathComponent("Waterm/Features/RemoteFiles/Application/RemoteFileInlineEditPolicy.swift")
        )
