...
struct TerminalTabManagerSuperfileBoundaryTests {
    ...
    func persistenceSnapshotLivesOutsideTerminalTabManagerFile() throws {
        ...
        let snapshotSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabsSnapshot.swift")
        )
    ...
    func snapshotStoreLivesOutsideTerminalTabManagerFile() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Infrastructure/TerminalTabsSnapshotStore.swift")
        )
    ...
    func persistenceOrchestrationLivesOutsideTerminalTabManagerFile() throws {
        ...
        let persistenceSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabManager+Persistence.swift")
        )
    ...
    func supportTypesLiveOutsideTerminalTabManagerFile() throws {
        ...
        let supportSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabManagerSupport.swift")
        )
    ...
    func paneInstallRequestIndexingUsesSharedStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalScopedRequestStore.swift")
        )
    ...
    func paneInputRequestIndexingUsesSerialStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalSerialRequestStore.swift")
        )
    ...
    func tabOpenRequestTrackingUsesOpenRequestStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalOpenRequestStore.swift")
        )
    ...
    func serverTeardownTaskTrackingUsesTeardownTaskStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTeardownTaskStore.swift")
        )
    ...
    func reconnectInFlightTrackingUsesReconnectInFlightStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalReconnectInFlightStore.swift")
        )
    ...
    func tmuxCleanupTrackingUsesTmuxCleanupStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTmuxCleanupStore.swift")
        )
    ...
    func connectWatchdogTrackingUsesWatchdogStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalConnectWatchdogStore.swift")
        )
    ...
    func paneConnectWatchdogLifecycleLivesOutsideTerminalTabManagerFile() throws {
        ...
        let watchdogSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabManager+Watchdog.swift")
        )
    ...
    func paneTerminalIORequestLifecycleLivesOutsideTerminalTabManagerFile() throws {
        ...
        let ioSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabManager+TerminalIO.swift")
        )
    ...
    func paneTerminalSurfaceLifecycleLivesOutsideTerminalTabManagerFile() throws {
        ...
        let surfaceSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalTabManager+TerminalSurfaces.swift")
        )
