...
struct ConnectionSessionManagerSuperfileBoundaryTests {
    ...
    func lifecycleSupportTypesLiveOutsideConnectionSessionManagerFile() throws {
        ...
        let supportSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalSessionLifecycleTypes.swift")
        )
    ...
    func persistenceSnapshotLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let snapshotSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionsSnapshot.swift")
        )
    ...
    func snapshotStoreLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Infrastructure/ConnectionSessionsSnapshotStore.swift")
        )
    ...
    func persistenceOrchestrationLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let persistenceSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionManager+Persistence.swift")
        )
    ...
    func supportTypesLiveOutsideConnectionSessionManagerFile() throws {
        ...
        let supportSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionManagerSupport.swift")
        )
    ...
    func shellHandlerTrackingUsesShellHandlerStore() throws {
        ...
        let storeSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/TerminalShellHandlerStore.swift")
        )
    ...
    func reliabilityManagerLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let reliabilitySource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionReliabilityManager.swift")
        )
    ...
    func sessionConnectWatchdogLifecycleLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let watchdogSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionManager+Watchdog.swift")
        )
    ...
    func terminalSurfaceManagementLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let surfaceSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionManager+TerminalSurfaces.swift")
        )
    ...
    func terminalIORequestLifecycleLivesOutsideConnectionSessionManagerFile() throws {
        ...
        let ioSource = try source(
            at: root.appendingPathComponent("Waterm/Features/TerminalSessions/Application/ConnectionSessionManager+TerminalIO.swift")
        )
