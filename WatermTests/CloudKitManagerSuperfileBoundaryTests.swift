...
struct CloudKitManagerSuperfileBoundaryTests {
    ...
    func managerRootDoesNotOwnCloudKitInfrastructureImplementation() throws {
        ...
        let managerSource = try source(
            at: root.appendingPathComponent("Waterm/Core/Sync/CloudKitManager.swift")
        )
        let infrastructureSource = try source(
            at: root.appendingPathComponent("Waterm/Core/Sync/CloudKitManager+Infrastructure.swift")
        )
